  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left Col: List */}
        <div className="lg:col-span-2 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 overflow-hidden flex flex-col h-[600px]">
           {/* Toolbar */}
                    ...
                    >
                       <div className="flex items-start gap-4">
                          <button 
                             ...
                             title={action.status === 'COMPLETED' ? "Marcar como pendiente" : "Marcar como completada"}
