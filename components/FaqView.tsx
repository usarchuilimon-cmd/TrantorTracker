...
export const FaqView = ({ faqs, tutorials }: FaqViewProps) => {
  ...
  return (
    <div className="space-y-6 md:space-y-8">
      {/* Hero / Header */}
      <div className="bg-gradient-to-r from-cyan-600 to-indigo-700 dark:from-cyan-900 dark:to-indigo-900 rounded-xl p-6 sm:p-10 text-white shadow-lg text-center relative overflow-hidden">
            ...
            {filteredFaqs.length > 0 ? (
              filteredFaqs.map((faq) => (
                ...
                >
                  ...
                  >
                    <div>
                      <span className="text-xs font-bold text-cyan-600 dark:text-cyan-400 uppercase tracking-wider mb-1 block group-hover:text-cyan-700 dark:group-hover:text-cyan-300 transition-colors">
                        {faq.category}
                      </span>
            ...
            {tutorials.map(tutorial => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center mt-3 text-sm text-gray-500 dark:text-slate-400 font-medium hover:text-cyan-600 dark:hover:text-cyan-300 transition-colors">
